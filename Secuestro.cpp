...
Secuestro::Secuestro(int numero_caso,vector<Evidencias> evidencia, string hora, string fecha, bool completado, string victima, string lugar_secuestro, string motivo, bool rescate, bool completado_caso):Caso(numero_caso, evidencia, hora, fecha, completado){
