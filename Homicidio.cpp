...
Homicidio::Homicidio(int numero_caso,vector<Evidencias> evidencia, string hora, string fecha, bool completado, vector<string> sospechosos, string sospechoso_principal, string victima):Caso(numero_caso, evidencia, hora, fecha, completado){
